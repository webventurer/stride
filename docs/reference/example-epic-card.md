...
A worked example of an epic card in Linear, drafted by [`/linear:plan-work`](/skills/linear#linear-plan-work) once it has saved the parent issue and the first batch of sub-issues. See [Epics and stories](/reference/epics-and-user-stories) for the full mechanism.
