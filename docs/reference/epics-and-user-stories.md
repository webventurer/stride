...
1. **Drafts the parent issue** using the [epic structure](/reference/issue-template#companion-epic-structure). The body has four sections — *Why this matters / What success looks like / What we agreed / What we won't touch* — strategic only, no implementation detail. The title is prefixed `Epic: ` so the umbrella is visible at a glance on the board.
